...
# ======================================================================
# Generate (POST) — enqueue an async job
# ======================================================================
...
class GenerateView(APIView):
    ...
    @ai_schema(
        ...
        description=(
            "Validates the prompt + variants count + aspect ratio, creates a queued "
            "GenerationJob, and dispatches a Celery task that boto3-invokes the "
            "generate_image Lambda in us-west-2. Returns 202 with a polling URL. "
            "Rate-limited per user (see AI_RATE_LIMIT_PER_HOUR)."
        ),
