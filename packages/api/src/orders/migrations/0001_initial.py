...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('posts', '0002_alter_postmedia_s3_key_raw'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('paid', 'Paid'), ('shipped', 'Shipped'), ('cancelled', 'Cancelled')], default='paid', max_length=16)),
                ...
                ('shipping_country', models.CharField(blank=True, default='', max_length=64)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
